...
const config = {
  ...
  tagline: 'Decentralised Data is cool',
  ...
  baseUrl: '/storage-system-documentation/',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} DecentralisedPro, the faculty of mathematics and physics, Charles University in Prague`,
      },
      prism: {
